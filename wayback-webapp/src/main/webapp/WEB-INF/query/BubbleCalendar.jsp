...
// gg: changed 'int year = 1991' to '1996' to fix display problem
// 1991 doesn't match use of 1996 as starting year in code on line 112
        ...
        <h2>
           ...
           <span class="search-date">
             <a href="<%= data.firstResultReplayUrl %>">
               <%= fmt.format("{0,date,MMMM d, yyyy}",data.firstResultDate) %>
             </a>
          </span>
          and
          <span class="search-date">
      ...
      <div id="wbChart" onmouseout="showTrackers('none'); setActiveYear(startYear);">
        <div id="wbChartThis">
              ...
              <div id="wm-ipp-sparkline" style="position:relative; white-space:nowrap; width:<%= imgWidth %>px;height:<%= imgHeight %>px;cursor:pointer;" title="<%= fmt.format("ToolBar.sparklineTitle") %>">
                  ...
                  if(i == 1991) {locationClass = "leftmost";}
